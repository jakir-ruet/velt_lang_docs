...
async fn docs(n: web::Path<String>) -> impl Responder
{
    ...
    {
        return HttpResponse::Ok().body(format!("{}{}", include_str!("../views/hello_world.html"), include_str!("../views/docs.html")))
    }
    return if name == "variables_&_specifier.html"
    {
        HttpResponse::Ok().body(format!("{}{}", include_str!("../views/variables_&_specifier.html"), include_str!("../views/docs.html")))
    } else {
